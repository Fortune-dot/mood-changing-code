          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span>Mood-Changing</span></h1>
                  <h2>inPods 12</h2>
                  <p>Get the New inPods 12 for both comfort and style </p>
                 
                </div>
                <div class="col-sm-6">
                  <img src="images/home/earpod.png" class="girl img-responsive" alt="" />
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>Mood-Changing</span></h1>
                  <h2>Laptop stand</h2>
                  <p>Versatile and sleek laptop stand with great features. </p>
                 
                </div>
                <div class="col-sm-6">
                  <img src="images/home/laptop-stand.png" class="girl img-responsive" alt="" />
                </div>
              </div>
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>Mood-Changing</span></h1>
                  <h2>Mi tv Stick</h2>
                  <p>The brand new revolutionary Mi TV Stick </p>
                 
                </div>
                <div class="col-sm-6">
                  <img src="images/home/mi-tv-stick.jpg" class="girl img-responsive" alt="" />
                </div>
              </div>
              ...
              <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                      ...
                      <br>
                      <button type="" name="lipanampesa" class="btn btn-success mpesa"><i class="fa fa-shopping-cart"></i>Lipa na Mpesa</button>
                      <br>
