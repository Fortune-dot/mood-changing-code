...
<head>
    ...
    <title>Mood Changing Accessories</title>
...
<body style="background-color:white" onload="totalprice()" >
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +254740408496</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> fortunelangat54@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
  ...
  <div class="navitem">
  <li><a    href=""></i> TRIPOD STANDS </a></li>

  </div>
<div class="navitem">
<li><a  href=""></i>BLUETOOTH SPEAKERS  </a></li>

</div>
<div class="navitem">
<li><a href=""></i> PROJECTORS</a></li>

</div>
<div class="navitem">
<li><a   href=""></i> ACCESSORIES</a></li>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>Mood </span>🐱‍👤</h2>
              <p>Accesories guaranteed to change your mood at affordable prices</p>
            </div>
          </div>
          <div class="col-sm-7">
            <div class="col-sm-6">
          ...
          <div class="col-sm-3">
            <div class="address">
              ...
              <p style="color:white;">Location Nakuru,Kenya</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-widget">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="single-widget">
              <h2>About Mood Changing Accesories</h2>
              <ul class="nav nav-pills nav-stacked">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Made witn 💖 by <span><a href="https://github.com/Fortune-dot">Langat Fortune</a></span></p>
        </div>
      </div>
    </div>
